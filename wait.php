	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>Sonko Rescue team is an organized company that rents cars and other vehicles to clients at lower cost. We we are here to serve every Kenyan citizen.</p>
					<ul>
